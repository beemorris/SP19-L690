...
map<string, double>             // return datatype
model_load(char *filename)      // function name and arguments
{
...
void
model_print(map<string, double> model)
{
...
double
model_score(map<string, double> model, vector<string> sent)
{
	double prob = 1.0;
...
string
model_sentence_tostring(vector<string> sent)
{
